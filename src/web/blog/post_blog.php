...
if(isset($_POST['blog_id'])) {
    echo "<script>window.location.href='/".$user_id."/".$blog_id."'</script>";
}
else {
    if ($id!==0) {
        echo "<script>window.location.href='/article/alist".$id."'</script>";
    }
    else {
        echo "<script>window.location.href='/".$user_id."'</script>";
    }
}
