...
">
    ...
    <link rel="stylesheet" href="<?php echo "/template/$OJ_TEMPLATE";?>/css/discuss.css">
    ...
    <div class="row row_user">
        ...
        <div class="col-lg-9 row_detail mod_blog">
            <div id="banner_detail">
                ...
                <br>
                <p class="detail_author">　　作者: <?php echo "<a target='_blank' href='/".$tmprow['user_id']."'>".getNickByid($tmprow['user_id'])."</a>";?>　　
                ...
                　|　<a href="/article/redit<?php echo $blog_id?>">重新编辑</a>　|　<a style="cursor: pointer;" onclick='blog_del(<?php echo $blog_id; ?>)'>删除</a>
                <?php }?>
                </p>
            </div>
            ...
            <div class="blog_msg" style="height: auto;border-bottom: 1px solid #DDD;">
                ...
                <?php if ($problem_id) { ?>
                    ...
                    ?>
                    <a style="margin-bottom: 30px;float: right;" href="/post_blog.php?blog_id=<?php echo $blog_id;?>">加精</a>
                    <?php } ?>
            ...
            <a style="display: block;color: #428bca;width: 100%;border-bottom: 1px solid #DDD;" class="blog_msg" href="<?php echo $url_oj_home;?>/vipjoin/">
            ...
            <div class="blog_msg">
                ...
                ?>
                    <div class="discuss_msg">
                        <div>
                             <div class="col-lg-2 text-center"> <a href="<?php echo $tmprow['user_id'];?>"> <?php echo $tmprow['nick'];?></a></div>
                        </div>                        
                        ...
                        <div hidden class="well" style="position:absolute;width:100%;">
                            <div class="comment_show">
                                ...
                                <div>
                                    <p>
                                        <a href="<?php echo $comment_row['user_id'];?>"><?php echo $comment_row['nick'];?></a>
                ...
                <ul class="pagination pull-right">
                 <?php
                    if($page==1) echo "<li class='disabled'><span>&laquo;</span></li>";
                        ...
                        echo "<li><a href='/".$user_id."/".$blog_id."-".($page-1)."'>&laquo;</a></li>";
                    }
                    $maxpag = 5;
                    ...
                    $stardian = "<li><a href='/".$user_id."/".$blog_id."-".($starpag-1)."'>···</a></li>";
                    $enddian = "<li><a href='/".$user_id."/".$blog_id."-".($endpag+1)."'>···</a></li>";
                    if($starpag!=1)echo $stardian;
                    for ($i=$starpag;$i<=$endpag;$i++){
                        if ($i==$page) echo "<li class='active'><a href='#'>".$i."</a></li>";
                        else {
                            echo "<li><a href='/".$user_id."/".$blog_id."-".$i."'>".$i."</a></li>";
                        }
                    }
                    if($endpag!=$view_total_page)echo $enddian;
                    if($page==$view_total_page) echo "<li class='disabled'><span>&raquo;</span></li>";
                    else {
                        echo "<li><a href='/".$user_id."/".$blog_id."-".($page+1)."'>&raquo;</a></li>";
                    }
                ?>
                </ul>
                </div>
                <form action="/post_blog_discuss.php" method="post" id="disForm">
                    <div>
