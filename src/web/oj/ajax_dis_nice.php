...
$sql = "UPDATE discuss SET nice=nice+1 WHERE discuss_id=$discuss_id";
mysqli_query($mysqli, $sql) or die('error');
echo "true";
setcookie(md5("disnice$discuss_id"),md5("as981jk2j"),time()+60*60*24);
$_SESSION[$tmp]=1;
