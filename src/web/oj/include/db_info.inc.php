<?php
header('Access-Control-Allow-Origin:https://blog.dotcpp.com');
...
// 检测是否有推广码，并将其存入 Session
require_once __DIR__ . '/mysqli.php';
require_once __DIR__ . '/distribution.class.php';
if (isset($_GET['ptcode'])) {
    $distributionInstance = new Distribution();
    $distributionInstance->sentPromotionCodeToSession();
}