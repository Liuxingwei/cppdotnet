...
$sql="SELECT `id`,`compname`,`position`,`place`,`propt`,`salary`,`release_time` FROM `job_list_modify` ORDER BY `release_time` DESC";
	...
	while ($row=mysqli_fetch_object($result)){
		$job_data[$i]=Array();
		$job_data[$i][0]="<a href='ver_job_detail.php?modify_id=".$row->id."'>".$row->position."</a>";
