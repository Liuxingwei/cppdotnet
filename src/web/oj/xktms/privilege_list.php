...
$sql="select * FROM privilege where rightstr in ('administrator','lowlevel_admin','source_browser','contest_creator','http_judge','problem_editor') ORDER BY rightstr";
...
for (;$row=mysqli_fetch_object($result);){
	echo "<tr>";
	echo "<td><a href='/home/".$row->user_id."'>".$row->user_id."</a>";
