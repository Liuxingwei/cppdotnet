...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" id="body">
        <div class="div-login div-reg">
            <div class="div_loginhead">
                <a href="loginpage_cpn.php"><label class="login_h1 login_h1_1 border2_r text-center">企业登录</label></a><label class="login_h1 login_h1_2 border0_l text-center">企业注册</label>
            </div> 
            <div class="div_loginform">
                <form action="register_cpn.php" method="post" class="form-horizontal col-lg-8 col-lg-offset-2" id="form">
                    
                    <div class="form-group">
                        <label for="" class="col-lg-3 col-lg-3-reg control-label">企业名称</label>
                         <div class="col-lg-5 col-lg-5-reg"><input type="text" name="compname" id="compname" class="form-control"></div>
                         <label for="" class="col-lg-4 col-lg-4-reg" id="compname_xx"></label>
                    </div>
                    <div class="form-group">
                        <label for="" class="col-lg-3 col-lg-3-reg control-label">联系电话</label>
                        <div class="col-lg-5 col-lg-5-reg"><input type="text" class="form-control" maxlength="30" placeholder="选填　座机请加上区号" name="phone" id="phone"></div>
                        <label for="" class="col-lg-4 col-lg-4-reg" id="phone_xx"></label>
                    </div>
                    <div class="form-group">
                        <label for="" class="col-lg-3 col-lg-3-reg control-label">公司地址</label>
                        <div class="col-lg-5 col-lg-5-reg"><input type="text" class="form-control" maxlength="50" placeholder="必填　至少具体至市" name="address" id="address"></div>
                    ...
                    <div class="form-group">
                        <label for="" class="col-lg-3 col-lg-3-reg control-label">用户名</label>
                        <div class="col-lg-5 col-lg-5-reg"><input type="text" class="form-control" name="cpnuser" id="cpnuser" placeholder="必填　唯一登录用户名 支持英文或数字"></div>
                        <label for="" class="col-lg-4 col-lg-4-reg" id="cpnuser_xx"></label>
                    </div>
                    <div class="form-group">
   ...
   <script src="template/<?php echo $OJ_TEMPLATE;?>/js/registerpage_cpn2.js"></script>
  </body>
</html>