...
">
    ...
    <title><?php echo "OI赛制排名 - C语言网";?></title>  
...
?>
        ...
        <div class="col-lg-9">
            ...
            <!-- </div>
            <div class="content_box"> -->
<table id=rank class="table table-striped table_style_new table_style_contest"><thead><tr class=toprow align=center><th class="{sorter:'false'}">名次</th><th>用户名</th><th>昵称</th><th>解决</th><th>罚时</th><th>分数</th>
<?php
/*for ($i=0;$i<$pid_cnt;$i++)
        ...
        <div class="col-lg-3">
            ...
            <div class="content_box">
                ...
                <ul class="nav nav-stacked nav-pills text-center">
                    ...
                    <li><a style="border-left: 6px solid #4071FD;font-weight: bolder;" href='contestrank-oi.php?cid=<?php echo $view_cid?>'>OI赛制排名</a></li>
