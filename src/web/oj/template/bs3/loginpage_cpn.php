  ...
  <body>
    ...
    <div class="div-login">
      <div class="div_loginhead">
        <label class="login_h1 login_h1_2 border0_r text-center">企业登录</label><a href="registerpage_cpn.php"><label class="login_h1 login_h1_1 border2_l text-center">企业注册</label></a>
      </div>
      <div class="div_loginform">
        <div class="div_loginform_login">
        <form action="login_cpn.php" method="post" role="form" class="form-horizontal col-lg-6 col-lg-offset-2" id="form">
        	<div class="form-group">
        	<!-- <label class="col-sm-4 control-label">用户名</label> -->
          <div class="col-sm-8 col-sm-8-login"><input name="cpnuser" class="form-control" placeholder="用户名" type="text"></div>
          </div>
          <br>
        	<div class="form-group">
