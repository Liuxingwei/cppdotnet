...
<script src="<?php echo $url_oj."template/$OJ_TEMPLATE/js/"?>jquery.min.js"></script>

<!-- 最新的 Bootstrap 核心 JavaScript 文件 -->
<script src="<?php echo $url_oj."template/$OJ_TEMPLATE/js/"?>bootstrap.min.js"></script>
...
-->
<script type="text/javascript" src="<?php echo $url_oj."template/$OJ_TEMPLATE/js/"?>scrolltoptip.js"></script>
<script>
	var _hmt = _hmt || [];
	(function() {
