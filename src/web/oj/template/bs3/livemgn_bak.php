...
<body>
	<div id="center">
		...
		?>
				...
				<tr><td><input type='text' name='id' placeholder='要更改的视频编号' class='form-control' autofocus /></td>
				<td><select name='state'><option value='直播'>直播</option><option value='录像'>录像</option></select></td>
				<td><input type='text' name='content' placeholder='请输入直播简介' class='form-control' /></td>
				<td><input type='text' name='teacher' placeholder='请输入老师名' class='form-control' /></td>
				<td><input type='date' name='date' placeholder='请输入直播时间' class='form-control' /></td>
				<td><input type='text' name='url' placeholder='请输入录像地址' class='form-control' /></td></tr>
				<tr><td><hr/></td></tr>
