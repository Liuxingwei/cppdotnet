    ...
    <div class="container">
        ...
        <div class="col-lg-8">
        	<div class="mod_blog mod_blogindex" style="width: 100%;">
        		<img src="/oj/template/bs3/img/blog_head_02.jpg">
        	</div>
        	<div class="mod_blog mod_blogindex" style="width: 100%;">
        		<div class="head_blogindex">
                    <h4 class="head_blogindex_text">最新文章</h4>
                    <a target='_blank' style="float: right;margin: 15px;" href="/blog/edit">去写文章</a>
                </div>
                ...
                <div class="head_blogindex" style="height: 54px;">
                    <a target='_blank' style="float: right;margin: 15px;" href="/blog/list">更多文章</a>
                </div>
        	</div>
        	<div class="mod_blog mod_blogindex" style="width: 100%;">
        		<div class="head_blogindex">
                    <h4 class="head_blogindex_text">最新题解</h4>
                    <a target='_blank' style="float: right;margin: 15px;" href="/oj/problemset.html">前往题库</a>
                </div>
        		<table class='table_list'>
        			<?php
