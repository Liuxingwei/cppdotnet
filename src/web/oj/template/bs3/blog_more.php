                    ...
                    <ul class="pagination pull-right">
                        <?php
                            ...
                            if($page==1) echo "<li class='disabled'><span>&laquo;</span></li>";
                                ...
                                echo "<li><a href='/blog/list?page=".($page-1);
                                echo "'>&laquo;</a></li>";
                            }
                            $maxpag = 7;
                            ...
                            $stardian = "<li><a href='/blog/list?page=".($starpag-1);
                            $stardian.="'>···</a></li>";
                            $enddian = "<li><a href='/blog/list?page=".($endpag+1);
                            $enddian.="'>···</a></li>";
                            if($starpag!=1)echo $stardian;
                            for ($i=$starpag;$i<=$endpag;$i++){
                                if ($i==$page) echo "<li class='active'><a href='#'>".$i."</a></li>";
                                else {
                                    echo "<li><a href='/blog/list?page=".$i;
                                    echo "'>".$i."</a></li>";
                                }
                            }
