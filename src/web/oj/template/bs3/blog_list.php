...
">
    ...
    <script src="<?php echo $url_oj."template/$OJ_TEMPLATE/js/"?>echarts.js"></script>
            ...
            <div id="banner_list" style="width: 100%;">
                <h3 class="list_head">　　<?php 
                    ...
                    <span style="margin-left: 20px;">
                        <a href="<?php echo $url_oj;?>problem<?php echo $id;?>.html">返回题目</a>　|　<a target='_blank' href="/blog/aedit<?php echo $id;?>">我来写题解</a>
                    </span>
            </div>
            <a style="display: block;color: #428bca;width: 100%;margin-bottom: 5px;" class="row mod_blog" href="/vipjoin/">
