        ...
        <div class="row row_user">
            ...
            <div class="col-lg-9">
                <div class="mod_blog mod_c">
                    <div id="banner_user">
                        <a href="/home/<?php echo $user_id;?>"><div class="user_head">TA的成绩</div></a><div class="user_head user_head0">TA的文章</div>
                        <?php 
                            if ($user_id==$_SESSION['user_id']) {
                        ...
                        <ul class="pagination pull-right">
                         <?php
                            if($page==1) echo "<li class='disabled'><span>&laquo;</span></li>";
                                ...
                                echo "<li><a href='/home/blog/".$user_id."/page".($page-1)."'>&laquo;</a></li>";
                            }
                            $maxpag = 5;
                            ...
                            $stardian = "<li><a href='/home/blog/".$user_id."/page".($starpag-1)."'>···</a></li>";
                            $enddian = "<li><a href='/home/blog/".$user_id."/page".($endpag+1)."'>···</a></li>";
                            if($starpag!=1)echo $stardian;
                            for ($i=$starpag;$i<=$endpag;$i++){
                                if ($i==$page) echo "<li class='active'><a href='#'>".$i."</a></li>";
                                else {
                                    echo "<li><a href='/home/blog/".$user_id."/page".$i."'>".$i."</a></li>";
                                }
                            }
                            if($endpag!=$view_total_page)echo $enddian;
                            if($page==$view_total_page) echo "<li class='disabled'><span>&raquo;</span></li>";
                            else {
                                echo "<li><a href='/home/blog/".$user_id."/page".($page+1)."'>&raquo;</a></li>";
                            }
                        ?>
                        </ul>
                        </div>
