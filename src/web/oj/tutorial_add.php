...
if(isset($_POST['order_id'])){
    ...
    $sql = "INSERT INTO tutorial (title, content, order_id, section) VALUES ('$title', '$content', '$order_id', '$section')";
            ...
            <div class="blog_msg">
        		<form action="#" method="post" onsubmit="return isDismsgEmpty(this);" id="">
                    ...
                    <div class="form-group">
                        ...
                        <input id="input_title" type="text" class="form-control" name="order_id">
                    </div>
                    <div class="form-group">
                        <label for="">章节（C语言：100+；　C++：200+）</label>
                        <input id="input_title" type="text" class="form-control" name="section">
                    </div>
                    <div>
                    	<label for="">内容</label>
                        <script id="tutorial_edit" name="content" type="text/plain"></script>
                	</div>
                    <hr style="border:0px;"/>
